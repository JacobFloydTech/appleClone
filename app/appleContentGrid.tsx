        ...
        <div className="h-auto grid grid-cols-2 grid-rows-3 mx-4 space-x-2 space-y-2 border-2 w-auto">
            ...
            <div style={{background: "url('/apple/wwdc.jpg')", backgroundPositionX: '-250px'}} className="border-black rounded-sm border-2">
                ...
                <div className="text-white text-2xl text-center mt-80 justify-center w-[600px] flex flex-col mx-auto">
                    ...
                    <div  onMouseOver={() => {setdevLearn(true)}} onMouseLeave={() => {setdevLearn(false)}}  className="text-blue-500 flex mt-2 text-xl align-center justify-center text-center w-[600px] mx-auto">
                        <p className={"text-blue-500 text-center" + (devLearn ? " underline" : null)}>Learn more</p>
                        <p className="ml-1">{">"}</p>
                    </div>
                </div>
            ...
            <div style={{background: "url('/apple/applewatch.jpg')", height: '100%', width: 'auto', backgroundPositionY: '0px', backgroundPositionX: "-250px", backgroundRepeat: 'no-repeat'}}>
                ...
                <div className="w-[150px] justify-center align-center text-center flex" onMouseOver={() => {setLearn(true)}} onMouseLeave={() => {setLearn(false)}}>
                        <p  className={"mr-1 flex" + (learn ? " underline" : null)}>Learn More</p>
                        <p >{">"}</p>
                    </div>
                    <div className="w-[100px] mr-2 justify-center align-center text-center flex"  onMouseOver={() => {setBuy(true)}} onMouseLeave={() => {setBuy(false)}}>
            ...
            <div style={{background: "url('/apple/cardbackground.jpg')", width: 'auto', height: '100%', backgroundPositionX: '-250px', backgroundRepeat: 'no-repeat'}}>
                ...
                <div className="w-[150px] justify-center align-center text-center flex" onMouseOver={() => {setcardLearn(true)}} onMouseLeave={() => {setcardLearn(false)}}>
                        <p  className={"mr-1 flex" + (cardLearn ? " underline" : null)}>Learn More</p>
                        <p >{">"}</p>
                    </div>
                    <div className="w-[150px] mr-2 justify-center align-center text-center flex"  onMouseOver={() => {setcardApply(true)}} onMouseLeave={() => {setcardApply(false)}}>
                        <p className={"mr-1 flex " + (cardApply ? " underline" : null)}>Apply now</p>
                        <p>{">"}</p>
                    </div>
                </div>
            </div>
            <div style={{background: "url('/apple/ipad.jpg')", width: 'auto', height: '100%', backgroundPositionX: '-250px'}} className="border-black border-2">
                ...
                <div className="text-blue-500 mt-2 text-xl justify-center text-center flex w-auto align-center mx-auto">
                    <div className="w-[150px] justify-center align-center text-center flex" onMouseOver={() => {setipadLearn(true)}} onMouseLeave={() => {setipadLearn(false)}}>
                        <p  className={"mr-1 flex" + (ipadLearn ? " underline" : null)}>Learn More</p>
                        <p >{">"}</p>
                    </div>
                    <div className="w-[100px] mr-2 justify-center align-center text-center flex"  onMouseOver={() => {setipadBuy(true)}} onMouseLeave={() => {setipadBuy(false)}}>
                        <p className={"mr-1 flex " + (ipadBuy ? " underline" : null)}>Buy</p>
                        <p>{">"}</p>
                    </div>
                </div>
            </div>
            <div style={{background: "url('/apple/privacyiphone.jpg')", height: 'auto', width: 'auto', backgroundPositionX: '-290px', backgroundPositionY: '36px', backgroundRepeat: 'no-repeat'}}>
                <div className="bg-black h-[50px]"></div>
                <p className="text-white font-semibold text-4xl flex w-[300px] mx-auto text-center align-center justify-center">Your health data. In your control.</p>
                <p className="text-white text-2xl flex text-center w-[300px] mx-auto justify-center mt-2">Privacy. That's iPhone</p>
                <div onMouseOver={() => {setprivacyLearn(true)}} onMouseLeave={() => {setprivacyLearn(false)}} className="text-blue-500 mt-2 text-xl justify-center text-center flex w-auto align-center mx-auto">
                    <p className={"mr-1 flex " + (privacyLearn ? " underline" : null)}>Learn more</p>
                    <p>{">"}</p>
                </div>
